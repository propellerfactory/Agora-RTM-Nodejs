export interface RTMController {
    ...
    onEvent<E extends keyof RTMControllerEvent>(eventName: E, callback: RTMControllerEvent[E]): void;
...
export interface RTMChannel {
    ...
    getMembers(): number;
    onEvent<E extends keyof RTMChannelEvent>(eventName: E, callback: RTMChannelEvent[E]): void;
    release(): void;
}
...
export declare const createInstance: () => RTMController;
